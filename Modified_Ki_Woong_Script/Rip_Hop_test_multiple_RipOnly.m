%%Modded the Rip_hop_test_mode.m file to allow multiple 3dlp to be cropped and save Ripley plot as .jpeg and .mat
%%in the same folder as the original dlp.

%%Rip_hop_modification: allow multiple inputs and export Ripley plot as .mat and .jpeg file 
%% User's inputs
clear al2
clc
