...
%%to csv in the same folder as the original dlp, and export Ripley plot as .jpeg and .mat to the same folder as the original dlp.
%%Rip_hop_modification: allow multiple inputs and export HOP analysis(mean, 25%, 50%, 75% quantile) as .csv file 
%%and export RIP plot as .jpeg and .mat file.
%% User's inputs
clear al2
clc
